...
for agents in range(10000):
	...
	vivo = random.choice(['SM-J210F','SM-J210G','SM-J210H','SM-J210GU'])
	...
	ua1 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/15.0.0.28.54;FBBV/46821846;FBDM/{density=3.0,width=1080,height=2340};FBLC/"+fblc+";FBRV/582591637;FBCR/"+fbcr+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+samsung+";FBSV/14;FBOP/6;FBCA/arm64-v8a:;]"
	...
	ua = str(random.choice([ua7,ua1]))  # Add ua6 to the list of choices
