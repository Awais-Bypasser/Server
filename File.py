...
for agents in range(10000):
    uas = ['SM-A307F','SM-A307FN','SM-A307G','SM-A307GN','SM-A307GT']
    ...
    so = random.choice(su)
    ua = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/164.0.0.35.99;FBBV/324189276;FBDM/{density=2.75,width=720,height=1560};FBLC/"+ap+";FBRV/271649429;FBCR/"+fd+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+ub+";FBSV/9.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    ugen.append(ua)
