...
for agents in range(10000):
	...
	ua10 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/72.0.0.38.15;FBBV/13822349;FBDM/{density=3.7,width=480,height=800};FBLC/de_DE;FBCR/Net10 Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-G313HZ;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"
