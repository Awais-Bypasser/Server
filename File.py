...
for agents in range(10000):
    ...
    so = random.choice(su)
    ua = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/361.0.0.40.121;FBBV/4433241;FBDM/{density=3.0,width=1080,height=2340};FBLC/"+ap+";FBRV/358162947;FBCR/"+fd+";FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/"+ub+";FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    ugen.append(ua)
