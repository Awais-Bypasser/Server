...
for agents in range(10000):
	samsung = random.choice(['CPH2363','CPH2461'])
	...
	lg = random.choice(['X626','X626B','X610B'])
	vivo1 = random.choice(['V2204','V2214'])
	sony = random.choice(['G3312','G3311','G3313'])
	...
	ua = str(random.choice([ua1,ua2,ua3,ua4,ua5,ua6,ua8]))  # Add ua6 to the list of choices
