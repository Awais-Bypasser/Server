...
for agents in range(10005):
	...
	ua6 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/49.0.0.18.16;FBBV/666395;FBDM/{density=2.8,width=800,height=1280};FBLC/es_BR;FBCR/Eco Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-T310;FBSV/4.2.2;nullFBCA/armeabi-v7a:armeabi;]"
