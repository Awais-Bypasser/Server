...
for agents in range(10000):
	...
	ua6 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+"[FBAN/Orca-Android;FBAV/463.1.0.53.85;FBBV/40379169;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_CX;FBCR/BLU;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-G610M;FBSV/8.1.0;nullFBCA/armeabi-v7a:armeabi;]"
	ua5 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/418.0.0.6.105;FBBV/18474187;FBDM/{density=1.85,width=540,height=960};FBLC/ar_ER;FBCR/Defense Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A300H;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]"
