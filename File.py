...
for agents in range(10005):
	samsung = random.choice(['LYA-L09','LYA-L29','LYA-AL00','LYA-AL10','LYA-TL00','LYA-L0C'])
	...
	so = random.choice(su)
	ua1 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/4433241;FBDM/{density=3.0,width=1440,height=3120};FBLC/en_GB;FBRV/384618284;FBCR/Jazz;FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/"+samsung+";FBSV/9.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
