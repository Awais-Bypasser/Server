...
for agents in range(10005):
	samsung = random.choice(['SM-T225','SM-T220','SM-T225N','SM-T227U'])
	oppo = random.choice(['CPH1909','CPH1920','CPH1912'])
	vivo = random.choice(['SM-A716F','SM-A7160','SM-A716B/DS','SM-A716U','SM-A716B','SM-A716U1'])
	realme = random.choice(['RMX1801','RMX1807','RMX1803'])
	...
	so = random.choice(su)
	ua1 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/4433241;FBDM/{density=2.25,width=800,height=1340};FBLC/"+ap+";FBRV/285914926;FBCR/"+fd+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+samsung+";FBSV/11;FBOP/14;FBCA/arm64-v8a:;]"
	ua2 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/4433241;FBDM/{density=3.0,width=1080,height=2340};FBLC/"+ap+";FBRV/381936593;FBCR/"+fd+";FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/"+realme+";FBSV/8.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua3 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/4433241;FBDM/{density=2.5,width=720,height=1520};FBLC/"+ap+";FBRV/185714729;FBCR/"+fd+";FBMF/oppo;FBBD/oppo;FBPN/com.facebook.katana;FBDV/"+oppo+";FBSV/8.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua4 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/396.1.0.28.104;FBBV/421951021;FBDM/{density=3.0,width=1080,height=2400};FBLC/"+ap+";FBRV/431726670;FBCR/"+fd+";FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/V2153;FBSV/12;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
