...
for agents in range(10000):
	...
	ua7 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/54.0.0.23.62;FBBV/3214247;FBDM/{density=1.1,width=720,height=1280};FBLC/zh_Hans_HK;FBCR/TracFone Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SHV-E210L;FBSV/4.0.4;nullFBCA/armeabi-v7a:armeabi;]"
