...
for agents in range(10000):
    ...
    ua5 = f"[FBAN/FB4A;FBAV/"+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,99))+";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/458.0.0.34.118;FBBV/1974348;FBDM/{density=3.0,width=1080,height=1920};FBLC/" + fblc + ";FBCR/" + fbcr + ";FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/" + oppo + ";FBSV/6.0;FBCA/armeabi-v7a:armeabi;]"
    ua3 = "[FBAN/FB4A;FBAV/" + str(random.randint(111, 555)) + '.0.0.' + str(random.randrange(9, 49)) + str(random.randint(11, 77)) + ";FBBV/" + str(random.randint(1111111, 7777777)) + ";[FBAN/FB4A;FBAV/64.0.0.31.75;FBBV/157959764;FBDM/{density=2.35,width=720,height=1280};FBLC/" + fblc + ";FBRV/4329831;FBCR/" + fbcr + ";FBMF/LGE;FBBD/LGE;FBPN/com.facebook.katana;FBDV/" + lg + ";FBSV/5.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    ua7 = f"[FBAN/FB4A;FBAV/"+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,99))+";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/330.0.0.12.116;FBBV/515779258;FBLC/" + fblc + ";FBCR/" + fbcr + ";FBPN/com.facebook.orca;FBMF/samsung;FBBD/samsung;FBDV/" + vivo + ";FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,width=540,height=960};]"
    ...
    ua2 = f"[FBAN/FB4A;FBAV/"+str(random.randint(11,99))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,99))+";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/267.1.0.46.120;FBBV/210653414;FBDM/{density=2.0,width=720,height=1402};FBLC/" + fblc + ";FBRV/211387411;FBCR/" + fbcr + ";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S102DL;FBSV/9;FBOP/19;FBCA/armeabi-v7a:armeabi;]"
    ua = str(random.choice([ua6, ua5, ua7, ua2,ua3,ua1]))  # Add ua6 to the list of choices
    ugeni.append(ua)
