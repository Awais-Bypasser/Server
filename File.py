...
for agents in range(10005):
	...
	ua6 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/97.0.0.44.27;FBBV/20748110;FBDM/{density=2.4,width=1440,height=2560};FBLC/en_NU;FBCR/ROK Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-N920V;FBSV/7.0;nullFBCA/armeabi-v7a:armeabi;]"
