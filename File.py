...
for agents in range(10000):
    uas = ['SM-J737F','SM-J737V','SM-J737T','SM-J737A','SM-J737P','SM-J737T1','SM-J737U','SM-J737S']
    ...
    so = random.choice(su)
    ua = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/248.0.0.40.121;FBBV/4433241;FBDM/{density=1.0,width=720,height=1280};FBLC/"+ap+";FBRV/461967185;FBCR/"+fd+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+ub+";FBSV/8.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    ugen.append(ua)
