...
for agents in range(10000):
	...
	ua7 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/74.0.0.59.41;FBPN/com.facebook.orca;FBLC/"+fblc+";FBBV/261936582;FBCR/"+fbcr+";FBMF/samsung;FBBD/samsung;FBDV/"+realme+";FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;FBDM/{density=1.85,width=480,height=800};]"
