...
for agents in range(10005):
	samsung = random.choice(['COR-L29','COR-L09','COR-AL00','COR-AL10','COR-TL10'])
	...
	ua6 = random.choice(["[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/4433241;FBDM/{density=2.75,width=720,height=1600};FBLC/en_PK;FBRV/185719264;FBCR/IND airtel;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LM-K420;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
