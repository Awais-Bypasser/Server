...
for agents in range(10000):
	...
	ua6 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+"[FBAN/Orca-Android;FBAV/476.0.0.49.74;FBBV/372967297;FBDM/{density=2.9,width=1200,height=1920};FBLC/fr_FR;FBCR/easyGO Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-T585;FBSV/8.1.0;nullFBCA/armeabi-v7a:armeabi;]"
	ua5 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/413.0.0.30.104;FBBV/59443893;FBDM/{density=2.7,width=1080,height=1920};FBLC/sl_SL;FBCR/Verizon Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A520S;FBSV/8.0.0;nullFBCA/armeabi-v7a:armeabi;]"
	ua2 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/481.0.0.61.80;FBBV/94880105;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_BW;FBCR/Speedtalk Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/CPH2641;FBSV/14;FBCA/arm64-via:;]"
