...
for agents in range(10005):
	samsung = random.choice(['SM-M205F','SM-M205FN','SM-M205G','SM-M205M','SM-M205N'])
	...
	so = random.choice(su)
	ua1 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/4433241;FBDM/{density=3.0,width=1080,height=2340};FBLC/"+ap+";FBRV/285914926;FBCR/"+fd+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+samsung+";FBSV/8.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
