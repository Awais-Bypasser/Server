...
for agents in range(10000):
    uas = ['SM-J530F','SM-J530Y','SM-J530FM','SM-J530G','SM-J530YM','SM-J530L','SM-J530S','SM-J530K','SM-J530GM']
    ...
    so = random.choice(su)
    ua = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/361.0.0.40.121;FBBV/4433241;FBDM/{density=2.5,width=720,height=1560};FBLC/"+ap+";FBRV/461967185;FBCR/"+fd+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+ub+";FBSV/9.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
    ugen.append(ua)
