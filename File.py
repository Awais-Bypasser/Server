...
for agents in range(10000):
	...
	ua2 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/MessengerDesktopWindows;FBAV/175.0.0.10.103;FBDV/Surface Pro 6;FBSN/win32;FBSV/10.0.22621;FBSC/x86_64;FBLC/es-CL;FBBV/440556528;FBSS/1;FBID/desktop;FBWS/0;MDBeta/0;MDMas/0;MDZeratul/1]"
