...
for agents in range(10005):
	samsung = random.choice(['SM-A310F','SM-A310M','SM-A310Y','SM-A310N0'])
	...
	so = random.choice(su)
	ua1 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/336.0.0.40.121;FBBV/184833241;FBDM/{density=2.5,width=720,height=1280};FBLC/"+ap+";FBRV/285914926;FBCR/"+fd+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+samsung+";FBSV/5.1.1;FBOP/1;nullFBCA/armeabi-v7a:armeabi;]"
