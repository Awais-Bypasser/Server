...
for agents in range(10000):
	samsung = random.choice(['SM-E500F','SM-E500F','SM-E500H','SM-E500H/DD','SM-E500H','SM-E500HQ','SM-E500M','SM-E500M','SM-E500YZ'])
	realme = random.choice(['V2025', 'V2024'])
	oppo = random.choice(['CHM-U01','CHC-U01','CHC-U23','CHC-U03','CHM-UL00','CHM-TL00','CHM-TL00H'])
	vivo = random.choice(['SM-T555','SM-T550','SM-P555','SM-P550'])
	fbcr = random.choice([
	...
	ua6 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/21.0.0.17.15;FBBV/571736413;FBDM/{density=2.29,width=768,height=1024};FBLC/"+fblc+";FBRV/162859173;FBCR/"+fbcr+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+vivo+";FBSV/5.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	ua5 = "[FBAN/FB4A;FBAV/"+str(random.randint(111,500))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/31.0.0.17.9;FBBV/471958164;FBDM/{density=2.14,width=720,height=1280};FBLC/"+fblc+";FBRV/361839672;FBCR/"+fbcr+";FBMF/HUAWEI;FBBD/HUAWEI;FBPN/com.facebook.katana;FBDV/"+oppo+";FBSV/6.0;FBCA/armeabi-v7a:armeabi;]"
	ua7 = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77))+";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/Orca-Android;FBAV/130.0.0.45.70;FBBV/75768478;FBDM/{density=3.4,width=1080,height=1920};FBLC/en_MH;FBCR/Flash Wireless;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-G610S;FBSV/9.0;nullFBCA/armeabi-v7a:armeabi;]"
