...
for agents in range(10005):
	...
	so = random.choice(su)
	ua1 = "Dalvik/2.1.0 (Linux; U; Android "+str(random.randint(4, 13))+"; "+efg+" Build/"+so+") [FBAN/FB4A;FBAV/"+str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/460.0.0.34.89;FBBV/588414891;FBDM/{density=2.0,width=720,height=1507};FBLC/en_GB;FBRV/0;FBCR/Warid;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/22120RN86G;FBSV/13;FBOP/1;FBCA/arm64-v8a:;]"
