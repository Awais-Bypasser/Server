...
for agents in range(10000):
    ...
    model_oppo = rc(['CPH2203', 'CPH3803', 'CPH3805','CPH1987','CPH1015', 'CPH1077', 'CPH1137', 'CPH1817', 'CPH1101', 'CPH1805', 'CPH1821'])
    chrome_oppo = f"{str(rr(80, 444))}.0.{str(rr(3000, 6500))}.{str(rr(11, 499))}"
    
    # Infinix device details
    models_inf = rc(['X655D', 'X662B', '559C', 'X601', '610B','X610B'])
    ...
    models_vivo = rc(['vivo 2018', 'V2238A', 'V2147','V2065A', 'V2135', 'V2022','V2027','V2023', 'V2110', 'vivo 1920','V2046','V2206','V2080A'])
    
    # Realme device details
    models_re = rc(['RMX1851', 'RMX1911', 'RMX1945','RMX1993','RMX2021', 'RMX2032', 'RMX2063','RMX2071','RMX2111', 'RMX2101', 'RMX2180','RMX3081'])
    ...
    models_sam = rc([model_sam_et, f"SM-A500{et}", f"SM-G920{et}", f"SM-J320{et}", f"SM-J510{et}", f"SM-G900{et}", f"SM-A426{et}", f"SM-A326{et}", f"SM-N915{et}", "EVR-TL00", "G620S-L01", 'LYA-L09','LYA-L29','LYA-AL00','LYA-AL10','LYA-TL00','LYA-L0C'])
